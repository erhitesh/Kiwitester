...
public class CommonAppAction extends AppAction {
	...
	public WebDriver getDisposableMail(String emailID) {
		WebDriver driver;
		try {
			System.setProperty("webdriver.chrome.driver", "/Users/kiwitech/Desktop/Automation/chromedriver/LatestChromeDriver");//"/Users/Sanjay/chromedriver");
	...
	public String topfanChangePassword(String emailID) {
		...
		try {
			...
			wait.until(ExpectedConditions
					.visibilityOfAllElementsLocatedBy(By.xpath("//td[contains(text(),'topfan.com')]")));
			driver.findElement(By.xpath("//td[contains(text(),'topfan.com')]")).click();
			Thread.sleep(2000);
