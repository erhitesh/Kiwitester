...
public class CreatorsLoginScreen {
	

	private WebDriver driver;

	public CreatorsLoginScreen(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void enterUserName(String username) throws Exception {
		...
		try {
			element = Locators.getInstance().creatorsEmailTextBox(driver);
	...
	public void enterPassword(String password) throws Exception {
		WebElement element = null;
		try {
			element = Locators.getInstance().creatorsPasswordTextBox(driver);
			Keywords.clearEditField(element);
	...
	public void loginUser() throws Exception { 
		WebElement element = null;
		try {
			element = Locators.getInstance().creatorsLoginButton(driver); 
