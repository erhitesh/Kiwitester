...
public class DriverFactory {
	...
	private ArrayList<String> BrowersOnGrid = new ArrayList<String>(
			Arrays.asList("CHROME", "FIREFOX", "SAFARI", "CHROME", "FIREFOX", "SAFARI", "CHROME", "FIREFOX", "SAFARI"));
...
//					capability.setCapability("locationContextEnabled", false);
//					profile.setPreference("app.update.enabled", false);
//					profile.setPreference("geo.prompt.testing", false);
//					profile.setPreference("geo.prompt.testing.allow", false);
//					profile.setPreference("geo.enabled", false);
//					profile.setPreference("geo.wifi.uri", "/Users/kiwitech/Desktop/firefox.json");
				...
				// selenium = new WebDriverBackedSelenium(driver1, getUrl(GlobalParam.SERVER_NAME));
			}
	...
	public String getUrl(String server) {
		System.out.println("************getUrl****************" + server + GlobalParam.masterProp.getProperty(server));
