...
public class CommonAll {
	...
	public void openBrowser(String url) throws Exception { // ##U
		try {
			...
			DriverSession.getLastExecutionReportingInstance().teststepreporting("<b>Browser opened</b>", "INFO",
					"<b>Browser should be Open</b>");
		} catch (Exception e) {
			DriverSession.getLastExecutionReportingInstance().teststepreporting("<b>Browser not opened</b>", "FAIL",
					"<b>Browser should be Open</b>");
