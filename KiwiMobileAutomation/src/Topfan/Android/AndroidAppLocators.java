...
public class AndroidAppLocators {
	...
	public WebElement acceptTestAppAlert(WebDriver driver) {
		return driver.findElement(By.xpath("//android.widget.Button[contains(@text,'Ok')]"));
	}
	
	public WebElement getRegisterButton(WebDriver driver) {
		WebElement element = driver.findElement(By.id("com.topfan.TopFan.EighteenSqueeler:id/btnRegister"));//(By.id("com.topfan.TopFan.TestApp:id/btnRegister"));
		return element;
	}

	public WebElement userFName(WebDriver driver) {
		return driver.findElement(By.id("com.topfan.TopFan.EighteenSqueeler:id/mRegisteruser_firstname"));
	}
	
	public WebElement userLName(WebDriver driver) {
		return driver.findElement(By.id("com.topfan.TopFan.EighteenSqueeler:id/mRegisteruser_lastname"));
	}
	...
	public WebElement getUserNameEditText(WebDriver driver, String screen) {
		...
		switch (screen) {
		case "Registration":
			element = driver.findElement(By.id("com.topfan.TopFan.EighteenSqueeler:id/etRegisterUsername"));
			break;
		case "SignIn":
			element = driver.findElement(By.id("com.topfan.TopFan.EighteenSqueeler:id/etLoginUserNameOrEmail"));
			break;
		default:
			element = null;
			break;
	...
	public WebElement getEmailEditText(WebDriver driver) {
		WebElement element = driver.findElement(By.id("com.topfan.TopFan.EighteenSqueeler:id/etRegisterEmail"));
		return element;
	}

	public WebElement getBirthdateDropDown(WebDriver driver) {
		WebElement element = driver.findElement(By.id("com.topfan.TopFan.EighteenSqueeler:id/btnBirthdate"));
		return element;
	}
	...
	public WebElement getLocationEditText(WebDriver driver) {
		WebElement element = driver.findElement(By.id("com.topfan.TopFan.EighteenSqueeler:id/etRegisterLocation"));
		return element;
	}
	...
	public WebElement getPasswordEditText(WebDriver driver, String screen) {
		...
		switch (screen) {
		case "Registration":
			element = driver.findElement(By.id("com.topfan.TopFan.EighteenSqueeler:id/etRegisterPassword"));
			break;
		case "SignIn":
			element = driver.findElement(By.id("com.topfan.TopFan.EighteenSqueeler:id/etLoginPassword"));
			break;
		default:
			element = null;
			break;
	...
	public WebElement sendMeMailUpdateCheckbox(WebDriver driver) {
		return driver.findElement(By.id("com.topfan.TopFan.EighteenSqueeler:id/email_option_checkbox"));
	}
	
	public WebElement authorizeCheckbox(WebDriver driver) {
		return driver.findElement(By.id("com.topfan.TopFan.EighteenSqueeler:id/additional_policy_checkbox"));
	}
	
	public WebElement getStartedButton(WebDriver driver) {
		WebElement element = driver.findElement(By.id("com.topfan.TopFan.EighteenSqueeler:id/register"));
		return element;
	}

	public WebElement getLoginButton(WebDriver driver) {
		WebElement element = driver.findElement(By.id("com.topfan.TopFan.EighteenSqueeler:id/btnLogin"));
		return element;
	}

	public WebElement getForgotPasswordLink(WebDriver driver) {
		WebElement element = driver.findElement(By.id("com.topfan.TopFan.EighteenSqueeler:id/tvForgotPassword"));
		return element;
	}

	public WebElement getSkipButton(WebDriver driver) {
		WebElement element = driver.findElement(By.id("com.topfan.TopFan.EighteenSqueeler:id/d_referral_button_submit_layout"));//(By.id("com.topfan.TopFan.TestApp:id/d_referral_button_submit_layout"));
		return element;
	}
	...
	public WebElement accessDeviceLocation(WebDriver driver) {
		return driver.findElement(By.id("com.android.packageinstaller:id/permission_allow_button"));
	}
	
	public WebElement skipReferralArrow(WebDriver driver) {
		return driver.findElement(By.id("com.topfan.TopFan.EighteenSqueeler:id/arrow"));
	}

	public WebElement getHomePageCheckElement(WebDriver driver) {
		WebElement element = driver.findElement(By.id("com.topfan.TopFan.EighteenSqueeler:id/action_toggle_feed_home"));//(By.id("com.topfan.TopFan.TestApp:id/action_toggle_feed_home"));
		return element;
	}
	...
	public WebElement getYearPicker(WebDriver driver) {
		WebElement element = driver.findElement(By.xpath("(//android.widget.EditText[@resource-id='android:id/numberpicker_input'])[3]"));//(By.id("android:id/numberpicker_input"));
		return element;
	}

	public WebElement getMonthPicker(WebDriver driver) {
		WebElement element = driver.findElement(By.xpath("(//android.widget.EditText[@resource-id='android:id/numberpicker_input'])[1]"));
		return element;
	}
	
	public WebElement getDay(WebDriver driver, String day) {
		WebElement element = driver.findElement(By.xpath("(//android.widget.EditText[@resource-id='android:id/numberpicker_input'])[2]"));//(By.xpath("//android.view.View//android.view.View[" + day + "]"));
		return element;
	}
	...
	public WebElement getAlertMessage(WebDriver driver) {
		WebElement element = driver.findElement(By.id("com.topfan.TopFan.EighteenSqueeler:id/frg_dialog_msg"));
		return element;
	}
	...
	public WebElement getSkipForNowButton(WebDriver driver) {
		WebElement element = driver.findElement(By.id("com.topfan.TopFan.EighteenSqueeler:id/tvGuestSignIn"));
		return element;
	}
	...
	public WebElement getEmailTextBoxOnWebView(WebDriver driver) {
		WebElement element = driver.findElement(By.xpath("//android.widget.EditText[@index='0']"));
		return element;
	}
	...
	public WebElement getUserNameOfFirstCardAfterTrendingCards(WebDriver driver, int index) {
		...
		WebElement element = driver.findElement(By.xpath("(//android.widget.TextView[@resource-id='com.topfan.TopFan.TestApp:id/tvUserName'])["+index+"]"));
		return element;
	}
	...
	public WebElement getStatusLevelOfFirstCardAfterTrendingCards(WebDriver driver, int index) {
		...
		WebElement element = driver.findElement(By.xpath("(//android.widget.TextView[@resource-id='com.topfan.TopFan.TestApp:id/tvUserLevel'])["+index+"]"));
		return element;
	}
	...
	public WebElement getPostMessageOfFirstCardAfterTrendingCards(WebDriver driver, int index) {
		...
		WebElement element = driver.findElement(By.xpath("(//android.widget.TextView[@resource-id='com.topfan.TopFan.TestApp:id/tvDiscussionTitle'])["+index+"]"));
		return element;
	}
	...
	public WebElement getMainImageOfFirstCardAfterTrendingCards(WebDriver driver, int index) {
		...
		WebElement element = driver.findElement(By.xpath("(//android.widget.ImageView[@resource-id='com.topfan.TopFan.TestApp:id/ivDiscussionImage'])["+index+"]"));
		return element;
	}

	public WebElement getUpperCharacterLimitAlert(WebDriver driver) {
		WebElement element = driver.findElement(By.id("android:id/parentPanel"));
		return element;
	}

	public By getLocatorOfProgressBar() {
		By by = By.id("com.topfan.TopFan.EighteenSqueeler:id/progressbar");//By.xpath("//android.widget.ProgressBar[@resource-id='com.topfan.TopFan.TestApp:id/progressbar']");
		return by;
	}
	...
	public List<WebElement> getAllCardsOnForumScreen(WebDriver driver) {
		List<WebElement> elements = driver.findElements(By.xpath("//android.widget.ListView[@resource-id='android:id/list']/android.widget.LinearLayout"));
		return elements;
	}
	...
	public WebElement getGuestLoginButton(WebDriver driver){
		WebElement element = driver.findElement(By.id("com.topfan.TopFan.EighteenSqueeler:id/button_login"));//(By.id("com.topfan.TopFan.TestApp:id/button_login"));
		return element;
	}
	
	public WebElement getTrendingTextOnForumCard(WebDriver driver, int index){
		WebElement element = driver.findElement(By.xpath("(//android.widget.TextView[@resource-id='com.topfan.TopFan.TestApp:id/tvTrending'])["+index+"]"));
		return element;
	}
	...
	public WebElement getGuestRegisterNowButton(WebDriver driver){
		WebElement element = driver.findElement(By.xpath("//android.widget.Button[@resource-id='com.topfan.TopFan.TestApp:id/button_register' and @text='Register Now']"));
		return element;
	}
	...
	public WebElement getFirstGiftOption(WebDriver driver){
		WebElement element = driver.findElement(By.xpath("(//android.widget.TextView[@resource-id='com.topfan.TopFan.TestApp:id/tvCoinCost'])[1]"));
		return element;
	}
	...
	public WebElement getMessageTextFromActivity(WebDriver driver, int index){
		WebElement element = driver.findElement(By.xpath("(//android.widget.TextView[@resource-id='com.topfan.TopFan.TestApp:id/message_text'])["+index+"]"));
		return element;
	}
	...
	public List<WebElement> getProgressBarsOfAUsedPollCard(WebDriver driver, int index){
		List<WebElement> elements = driver.findElements(By.xpath("(//android.widget.Button[@resource-id='com.topfan.TopFan.TestApp:id/btnvoted'])[" + index
	...
	public WebElement getRewardEarnedOnCompletingPoll(WebDriver driver, int index){
		WebElement element = driver.findElement(By.xpath("(//android.widget.TextView[@resource-id='com.topfan.TopFan.TestApp:id/tvpollCoinAmount'])["+index+"]"));
		return element;
	}
	
	public WebElement getAppSpecificStatusBar(WebDriver driver){
		WebElement element = driver.findElement(By.xpath("//android.view.View[@resource-id='android:id/statusBarBackground' and @package='com.topfan.TopFan.EighteenSqueeler']"));
		return element;
	}
	...
	public WebElement getFeedAvatar(WebDriver driver, int index){
		WebElement element = driver.findElement(By.xpath("(//android.widget.ImageView[@resource-id='com.topfan.TopFan.TestApp:id/ivUserPicture'])["+index+"]"));
		return element;
	}
